...
import in.pm.wikipedia.Adapter.IntroViewPagerAdapter;
import in.pm.wikipedia.Dashboard.Landing;
import in.pm.wikipedia.Model.ScreenItem;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restorePreData()){
            Intent mainActivity = new Intent(getApplicationContext(), Spalsh2.class);
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mainActivity = new Intent(getApplicationContext(), Landing.class);
                startActivity(mainActivity);
                savePrefsData();
                finish();
            }
